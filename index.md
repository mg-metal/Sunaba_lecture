...
- その目的意識が `とりあえずやってみたい！` であっても、それは立派な目的なので歓迎します
- 本内容はC言語を学ぶ前提で話を進める。とはいえC言語以外につながる内容も含むので、C言語を学ぶ予定がなくても、Sunabaが楽しいと思える人は本テキストを利用してください
...
- Sunaba.exe 実行時、`.NetFramework*******`というメッセージが表示される場合がある。その場合は指示に従い必要なものをダウンロード＆インストールすること
