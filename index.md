# Sunaba講座
## 本講座の対象
- C言語習得を迫られているのに、プログラミング学習歴が無い、もしくは無いに等しい人。
...
## 何のためにプログラミングを勉強するのか？
- 今後C言語を学ぶ人が対象なので、本内容は学習後にC言語を学ぶ前提で話を進める
- とはいえC言語以外の汎用性のある内容も含んでいるので、Sunabaが合う人は本テキストを使ってもらって構わない
- しかしできれば `何のためにプログラムを学ぶか` を意識して、ここでの学習が役立ちそうかどうかを判断してもらいたい
